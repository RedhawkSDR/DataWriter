# REDHAWK Basic Components DataWriter
 
## Description

Contains the source and build script for the REDHAWK Basic Components DataWriter.
...
REDHAWK Basic Components DataWriter is licensed under the GNU Lesser General Public License (LGPL).
